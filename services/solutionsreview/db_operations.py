"""
Database operations for SolutionsReview news data
...
class SolutionsReviewDataOperations:
    """Handle database operations for SolutionsReview scraped news"""
    ...
    def _save_article(self, competitor_id: int, company_name: str, article: Dict) -> bool:
        ...
        try:
            ...
            if self.news_analyzer and content:
                ...
                sentiment = 'neutral'
                analysis_text = f"SolutionsReview article about {company_name}"
                importance_grade = 5
