"""
SolutionsReview Enrichment Service
Processes all competitors to find and analyze news articles from solutionsreview.com
"""
...
class SolutionsReviewEnrichmentService:
    """Service to enrich all competitors with SolutionsReview news articles"""
    ...
    def __init__(self, analyze_news: bool = True):
        ...
        """
        self.scraper = SolutionsReviewScraper()
        self.db_ops = SolutionsReviewDataOperations(analyze_news=analyze_news)
    ...
    async def _process_competitor(self, company_name: str) -> Dict:
        ...
        try:
            # Scrape articles from SolutionsReview
    ...
    async def enrich_all_competitors(self, competitor_names: List[str] = None) -> Dict:
        """
        Enrich all competitors with SolutionsReview articles
        ...
        print(f"📊 Processing {len(competitor_names)} competitors for SolutionsReview articles...")
        print("=" * 80)
        ...
        # Print summary
        print("\n" + "=" * 80)
        print("🎉 SOLUTIONSREVIEW ENRICHMENT COMPLETE!")
        print("=" * 80)
...
async def enrich_competitors_with_solutionsreview(competitor_names: List[str] = None, analyze_news: bool = True):
    """
    Quick function to enrich competitors with SolutionsReview articles
    
    Args:
        competitor_names: List of company names to process (optional)
        analyze_news: Whether to use AI analysis (default: True)
    """
    service = SolutionsReviewEnrichmentService(analyze_news=analyze_news)
